...
from .reg_api_view import (submit_student_reg_score,mass_submit_student_reg_score)
...
urlpatterns = [
    ...
    path('mass-submit-student-reg-score',mass_submit_student_reg_score , name='mass_submit_student_reg_score'),
