                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                            <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                                <!-- Form -->
                                <form action="{{route('saveregister')}}" method="post" class="row g-1 p-3 p-md-4">
                                     @csrf
                                <div class="col-12 text-center mb-1 mb-lg-5">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="password" name="password_confirmation" id="confirm_pass" class="form-control form-control-lg" placeholder="8+ characters required">
                                        </div>
                                    </div>
