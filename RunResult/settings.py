"""
python manage.py runserver 10.10.10.14:80 --noreload --insecure

Django settings for RunResult project.
...
SECRET_KEY = 'django-insecure-*)(-0$(2tu=20k!5zzn^oq%v=j=5v2s^$$suhtw#89nl#y_uu!'
...
WSGI_APPLICATION = 'RunResult.wsgi.application'
